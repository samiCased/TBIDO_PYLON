...
class MentoringScheduleAdmin(admin.ModelAdmin):
    list_display = ('session_topic', 'session_time', 'cohort_name', 'mentor_name')
    search_fields = ('session_topic', 'cohort_name', 'mentor_name')
    ordering = ('-session_time',)

admin.site.register(MentoringSchedule, MentoringScheduleAdmin)
